...
#PBS -A UMIC0126
#PBS -j oe
#PBS -o logs/thermal_for_05_08_26.out
...
# ── Environment ───────────────────────────────────────────────────────────────
module load conda
conda run -p /glade/work/rbhandarkar/conda-envs/assetra_gl python generate_thermal_FORs.py --year $YEAR --ensemble $MEMBER --rcp $RCP
